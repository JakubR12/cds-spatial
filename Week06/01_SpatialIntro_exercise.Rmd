...
p1 is clustered, p2 is clustered
```{r}
# loading data
...
# p1
p1_cluster <- rThomas(kappa = 0.35, scale = 1, mu = 3, win = disc10)
p1_regular <- rStrauss(beta = 2.9, gamma = 0.025, R = .5, W = disc10)

quadrat.test(p1_cluster, alternative = "clustered")
quadrat.test(p1_regular, alernative = "regular")

# p2
p2_cluster <- rThomas(kappa = 0.35, scale = 1, mu = 3, win = disc10)
p2_regular <- rStrauss(beta = 2.9, gamma = 0.025, R = .5, W = disc10)

quadrat.test(p2_cluster, alternative = "clustered")
quadrat.test(p2_regular, alernative = "regular")
