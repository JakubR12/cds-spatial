...
* I can reject the null hypothesis with p-value less than 0.01 Yes
...
readoak_k <- Kest(redoak, correction = "border")
readoak_k

redoak_env <- envelope(redoak, Kest, correction = "border")

plot(redoak_env,  . - pi * r ^ 2 ~ r)
